    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_updated', models.DateField(default=datetime.datetime(2022, 5, 16, 18, 41, 55, 287882))),
            ],
        ),
        migrations.CreateModel(
            name='SkiInstructor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100)),
                ('root', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='jahorina.rootcategory')),
            ],
        ),
        migrations.CreateModel(
            name='Acitivity',
